...
describe('11 - Crie um componente `<Rating />`', () => {
  xit('Renderize o componente `<Rating />`', () => {
    shallow(<Rating />);
  });
});
...
describe('12 - Renderize a nota de um filme dentro de `Rating`', () => {
  let wrapper;
  xit('Renderize a nota de um filme dentro de `Rating`', () => {
...
describe('13 - Renderize o componente `<Rating />` dentro de `<MovieCard />`', () => {
  ...
  xit('Renderize o componente `<Rating />` dentro de `<MovieCard />`', () => {
...
describe('14 - Passe como prop para o componente `<Rating/>` o atributo `rating`', () => {
  let wrapper;
  const movie = movies[0];
  xit('Passe como prop para o componente `<Rating />` o atributo `rating`', () => {
